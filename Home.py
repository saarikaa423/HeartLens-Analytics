...
from Apps import Hypertension_App, Stroke_App, Heart_Disease
...
st.set_page_config(
    page_title="HeartLens Analytics",
    page_icon=Image.open("images/medical.png"),
    layout="wide"
)
...
lottie_coding = load_lottiefile("res/Home-Animation.json")
